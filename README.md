...
<div align="center">
  ...
  <p>
    💻 <strong>Backend:</strong> Java, Python, Node.js <br>
    🎨 <strong>Frontend:</strong> Kotlin (Android), HTML, CSS, JavaScript
  </p>
  <p>
    💬 <strong>Ask me about:</strong> Mobile App Development, RESTful APIs, Web Development  
    <br>
